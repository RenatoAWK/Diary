...
public final class Constants {
    ...
    public static final String USER_COLUMN_EMAIL = "__email";
    public static final String USER_COLUMN_PASSWORD = "__password";
    ...
    public static final String NOTE_COLUMN_EDITED = "__edited";
